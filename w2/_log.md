# Tasukami Wiki w2 — Log

## [2026-05-01] ingest | raw2/ゆるい知的生産.md（役割: ゆるい知的生産を支持する個人 SE）

役割: 独立した個人開発者または企業内 IC / スタッフエンジニア / R&D 上級・主席研究者で、自律性が高く「知的生産はストイックではない」という [raw2/ゆるい知的生産.md](../raw2/ゆるい知的生産.md) の立場を支持する人物。

作成ページ:

- [home_loose_intellectual.md](home_loose_intellectual.md) — 役割のホーム。ゆるい知的生産の前提・5 つの問い・コメントノート索引
- [comment_etm.md](comment_etm.md) — [w1/ETM](../w1/etm.md) へ。No ABCD はゆるい知的生産の運用形そのもの
- [comment_ltm.md](comment_ltm.md) — [w1/LTM](../w1/ltm.md) へ。ライティングスタックの肯定 + LLM 時代の問い
- [comment_exploration.md](comment_exploration.md) — [w1/模索](../w1/exploration.md) へ。「店頭で物色する感覚」の支持
- [comment_inboxer.md](comment_inboxer.md) — [w1/Inboxer](../w1/inboxer.md), [w1/アクティブレイジー](../w1/active_lazy.md) へ。既存動線に乗ることの正当化
- [comment_slackist.md](comment_slackist.md) — [w1/スラキスト](../w1/slackist.md), [w1/フラティズム](../w1/flatism.md) へ。Minimize Negatives は独立 IC の生命線
- [comment_rejecter_automaton.md](comment_rejecter_automaton.md) — [w1/リジェクター](../w1/rejecter.md), [w1/オートマトン](../w1/automaton.md) へ。怠けるための仕組みづくり
- [comment_furikaeri.md](comment_furikaeri.md) — [w1/振り返り](../w1/furikaeri.md) へ。たすかみで最もストイック側に倒れている章。注意点を整理

主要な発見:

- たすかみは敵ではない。ETM / LTM / Inboxer / アクティブレイジー / スラキスト / リジェクター / オートマトンの章はゆるい知的生産そのものに近い
