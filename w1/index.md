...
- [MCA](mca.md) — Management / Control / Administration
- [タスク管理の公理](axioms.md)
...
- [Alternate モデル](alternate_model.md) — 4 段階
- [ビューの種類](views.md) — リスト/テーブル/ボード/チャート/ネットワーク/センテンス

### プロジェクトタスク管理: シャドータスクとその対処
- [シャドータスク](shadow_task.md)
- [キャパシティ](capacity.md)
- [バッファとスラック](buffer_slack.md)

### プロジェクトタスク管理: 5 つの管理対象
